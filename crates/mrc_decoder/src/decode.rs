...
pub fn decode_instruction(it: &mut impl Iterator<Item = u8>) -> Result<Instruction> {
    ...
    match op_code {
        ...
        0x40..=0x4F => Ok(Instruction::new(
            ...
            OperandSet::Destination(Operand(
                OperandKind::Register(Register::try_from_byte(op_code & 0b111)?, OperandSize::Word),
                OperandSize::Word,
            )),
        )),
        ...
        0x91..=0x97 => {
            ...
            let destination = Operand(
                OperandKind::Register(Register::AlAx, operand_size),
                operand_size,
            );
            let source = Operand(
                OperandKind::Register(Register::try_from_byte(op_code & 0b111)?, operand_size),
                operand_size,
            );
            Ok(Instruction::new(
                Operation::XCHG,
        ...
        0xA0..=0xA3 => {
            ...
            let direct = Operand(
                OperandKind::Direct(Segment::DS, address, operand_size),
                operand_size,
            );
        ...
        0xD0..=0xD3 => {
            ...
            let source = if (op_code >> 1) & 0b1 == 1 {
                Operand(
                    OperandKind::Register(Register::ClCx, operand_size),
                    operand_size,
                )
            } else {
                Operand(
        ...
        0xEC | 0xED => {
            ...
            Ok(Instruction::new(
                ...
                OperandSet::DestinationAndSource(
                    ...
                    Operand(
                        OperandKind::Register(Register::DlDx, OperandSize::Word),
                        OperandSize::Word,
                    ),
                ),
            ))
    ...
    fn test_00() {
        test_decoder!(
            ...
            Instruction::new(
                ...
                OperandSet::DestinationAndSource(
                    Operand(
                        OperandKind::Register(Register::BhDi, OperandSize::Byte),
                        OperandSize::Byte
                    ),
                    Operand(
                        OperandKind::Register(Register::DhSi, OperandSize::Byte),
                        OperandSize::Byte
                    ),
                )
            )
    ...
    fn test_02() {
        test_decoder!(
            ...
            Instruction::new(
                ...
                OperandSet::DestinationAndSource(
                    Operand(
                        OperandKind::Register(Register::AhSp, OperandSize::Byte),
                        OperandSize::Byte
                    ),
                    Operand(
                        OperandKind::Register(Register::DhSi, OperandSize::Byte),
    ...
    fn test_03() {
        test_decoder!(
            ...
            Instruction::new(
                ...
                OperandSet::DestinationAndSource(
                    Operand(
                        OperandKind::Register(Register::AlAx, OperandSize::Word),
                        OperandSize::Word
                    ),
                    Operand(
                        OperandKind::Indirect(
    ...
    fn test_04() {
        test_decoder!(
            ...
            Instruction::new(
                ...
                OperandSet::DestinationAndSource(
                    Operand(
                        OperandKind::Register(Register::AlAx, OperandSize::Byte),
                        OperandSize::Byte
                    ),
                    Operand(
        ...
        test_decoder!(
            ...
            Instruction::new(
                ...
                OperandSet::DestinationAndSource(
                    ...
                    Operand(
                        OperandKind::Register(Register::ChBp, OperandSize::Word),
                        OperandSize::Word
                    ),
                )
            )
        ...
        test_decoder!(
            ...
            Instruction::new(
                ...
                OperandSet::DestinationAndSource(
                    ...
                    Operand(
                        OperandKind::Register(Register::DhSi, OperandSize::Word),
                        OperandSize::Word
                    ),
                )
            )
        ...
        test_decoder!(
            ...
            Instruction::new(
                ...
                OperandSet::DestinationAndSource(
                    ...
                    Operand(
                        OperandKind::Register(Register::DlDx, OperandSize::Byte),
                        OperandSize::Byte
                    ),
                )
            )
        ...
        test_decoder!(
            ...
            Instruction::new(
                ...
                OperandSet::DestinationAndSource(
                    ...
                    Operand(
                        OperandKind::Register(Register::AhSp, OperandSize::Word),
                        OperandSize::Word
                    ),
                )
            )
    ...
    fn test_1a() {
        test_decoder!(
            ...
            Instruction::new(
                ...
                OperandSet::DestinationAndSource(
                    Operand(
                        OperandKind::Register(Register::BlBx, OperandSize::Byte),
                        OperandSize::Byte
                    ),
                    Operand(
                        OperandKind::Indirect(
    ...
    fn test_23() {
        test_decoder!(
            ...
            Instruction::new(
                ...
                OperandSet::DestinationAndSource(
                    Operand(
                        OperandKind::Register(Register::BlBx, OperandSize::Word),
                        OperandSize::Word
                    ),
                    Operand(
                        OperandKind::Indirect(
    ...
    fn test_2b() {
        test_decoder!(
            ...
            Instruction::new(
                ...
                OperandSet::DestinationAndSource(
                    Operand(
                        OperandKind::Register(Register::ClCx, OperandSize::Word),
                        OperandSize::Word
                    ),
                    Operand(
                        OperandKind::Indirect(
        ...
        test_decoder!(
            ...
            Instruction::new(
                ...
                OperandSet::DestinationAndSource(
                    ...
                    Operand(
                        OperandKind::Register(Register::ChBp, OperandSize::Byte),
                        OperandSize::Byte
                    ),
                )
            )
    ...
    fn test_33() {
        test_decoder!(
            ...
            Instruction::new(
                ...
                OperandSet::DestinationAndSource(
                    Operand(
                        OperandKind::Register(Register::BhDi, OperandSize::Word),
                        OperandSize::Word
                    ),
                    Operand(
                        OperandKind::Register(Register::ChBp, OperandSize::Word),
        ...
        test_decoder!(
            ...
            Instruction::new(
                ...
                OperandSet::DestinationAndSource(
                    ...
                    Operand(
                        OperandKind::Direct(Segment::DS, 0x430c, OperandSize::Byte),
                        OperandSize::Byte
                    ),
                )
            )
        ...
        test_decoder!(
            ...
            Instruction::new(
                ...
                OperandSet::DestinationAndSource(
                    ...
                    Operand(
                        OperandKind::Direct(Segment::DS, 0x8be5, OperandSize::Word),
                        OperandSize::Word
                    ),
                )
            )
    ...
    fn test_a2() {
        test_decoder!(
            ...
            Instruction::new(
                ...
                OperandSet::DestinationAndSource(
                    Operand(
                        OperandKind::Direct(Segment::DS, 0x9d98, OperandSize::Byte),
                        OperandSize::Byte
                    ),
                    Operand(
                        OperandKind::Register(Register::AlAx, OperandSize::Byte),
    ...
    fn test_a3() {
        test_decoder!(
            ...
            Instruction::new(
                ...
                OperandSet::DestinationAndSource(
                    Operand(
                        OperandKind::Direct(Segment::DS, 0xf847, OperandSize::Word),
                        OperandSize::Word
                    ),
                    Operand(
                        OperandKind::Register(Register::AlAx, OperandSize::Word),
