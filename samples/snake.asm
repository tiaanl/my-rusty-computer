...
; https://raw.githubusercontent.com/cepa/snake/master/snake.asm
...
text_about1     DB 'SNAKE',0
text_about2     DB 'Version 1.0',0
text_about3     DB 'By CEPA 2004',0
text_about4     DB ' Visit cepa.io',0
text_pause      DB 'PAUSE',0
text_game_over  DB 'GAME OVER',0
text_winner1    DB '!!! Your Snake is dead !!!',0
text_winner2    DB '!!! It was too big :) !!!',0
